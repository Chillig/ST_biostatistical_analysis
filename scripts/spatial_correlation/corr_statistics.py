"""Statistics: (Weighted) Pearson Correlation, Wilconxon rank sum test, Shapiro test, Skewness, and Kurtosis
    File name: st_plots.py
...
def weighted_cov(x, y, w):
    ...
    :param x: responder counts
    :param y: cytokine counts
    :param w: size of cyto+ clusters
