...
def main(save_folder, adata):
    ...
    density_clustering.main(adata=adata, save_folder=save_folder, tissue_types=tissue_layers,
...
if __name__ == '__main__':
    ...
    unpp_st_adata = sc.read(os.path.join(path, "adata_storage", "2020-10-06", "st_adata_P15509_P16357_wo_4_7_unpp.h5"))
