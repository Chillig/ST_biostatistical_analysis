...
def main(save_folder: str, spatial_adata, spatial_cluster_label: str = 'tissue_layer'):
    ...
    # Suppl. Figure 2C
    visualise_clusters(adata=adata_leukocytes, save_folder=save_folder, key=spatial_cluster_label,
    ...
    sc.pl.matrixplot(adata_cytos, coexpressed_cytos, groupby='cytokines_others',  layer='counts',
                     dendrogram=True, figsize=(10, 6), show=False)
    ...
    sc.pl.heatmap(adata_cytos, coexpressed_cytos, groupby='cytokines_others', layer='counts',
                  figsize=(10, 6), dendrogram=True, show=False)
