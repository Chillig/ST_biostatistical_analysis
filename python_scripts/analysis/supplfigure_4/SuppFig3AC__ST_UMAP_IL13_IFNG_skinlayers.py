#!/usr/bin/env python
"""Plot UMAP of IL13 and IFNG positive spots in skin layers
    File name: SuppFig3AC__ST_UMAP_IL13_IFNG_skinlayers.py
...
def main(save_folder, spatial_adata, spatial_cluster_label: str = 'tissue_layer'):
    ...
    # 3. Highlight tissues epidermis and dermis + cytokines and for each single cytokine
...
if __name__ == '__main__':
    ...
    output_path = os.path.join("..", "..", "..", "output", "SupplFigure_3AC", str(today))
